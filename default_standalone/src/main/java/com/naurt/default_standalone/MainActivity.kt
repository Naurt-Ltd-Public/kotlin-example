...
import com.naurt.*
import default_standalone.BuildConfig
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!Naurt.getInitialised()) {
            scheduledExecutor.submit {
                val status = Naurt.initialiseStandalone(BuildConfig.API_KEY, this)
            }
        }
    ...
    private val requestPermissionsLauncher =
        registerForActivityResult(
            ...
            // decision.
            Log.e("default_standalone", "Permission matrix: $map")
        }
    ...
    private val requestPermissionLauncher =
        registerForActivityResult(
            ...
            if (!isGranted) {
                Log.e("default_standalone", "Background Permission not granted")
            }
        }
